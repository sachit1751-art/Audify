...
import com.sachit.music.recognition.MusicRecognitionService
import com.sachit.music.recognition.RecognitionForegroundService
import com.sachit.music.recognition.RecognitionForegroundService.Companion.ALBUM_ART_CACHE_FILE
import com.sachit.music.recognition.RecognitionForegroundService.Companion.PREF_ARTIST_NAME
import com.sachit.music.recognition.RecognitionForegroundService.Companion.PREF_COVER_ART_PATH
import com.sachit.music.recognition.RecognitionForegroundService.Companion.PREF_ERROR_MESSAGE
import com.sachit.music.recognition.RecognitionForegroundService.Companion.PREF_PULSE_FRAME
import com.sachit.music.recognition.RecognitionForegroundService.Companion.PREF_SONG_TITLE
import com.sachit.music.recognition.RecognitionForegroundService.Companion.PREF_STATE
import com.sachit.music.recognition.RecognitionForegroundService.Companion.PREFS_NAME
import com.sachit.music.recognition.RecognitionForegroundService.Companion.STATE_ERROR
import com.sachit.music.recognition.RecognitionForegroundService.Companion.STATE_IDLE
import com.sachit.music.recognition.RecognitionForegroundService.Companion.STATE_LISTENING
import com.sachit.music.recognition.RecognitionForegroundService.Companion.STATE_NO_MATCH
import com.sachit.music.recognition.RecognitionForegroundService.Companion.STATE_PROCESSING
import com.sachit.music.recognition.RecognitionForegroundService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "com.sachit.music.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "com.sachit.music.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "com.sachit.music.widget.recognizer.RESET"
    }
}
