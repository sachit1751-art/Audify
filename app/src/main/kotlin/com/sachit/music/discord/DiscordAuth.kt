...
import com.sachit.music.discord.DiscordDefaults.DISCORD_OAUTH_AUTHORIZE
import com.sachit.music.discord.DiscordDefaults.DISCORD_OAUTH_TOKEN
import com.sachit.music.discord.DiscordDefaults.DISCORD_SCOPES
...
class DiscordAuth(
    ...
    companion object {
        ...
        const val REDIRECT_URI = "sachit-musicdiscord://oauth2/callback"
