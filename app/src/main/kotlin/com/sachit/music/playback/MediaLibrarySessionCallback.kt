...
import com.sachit.music.constants.AndroidAutoSearchLocalLimitKey
...
import com.sachit.music.constants.AndroidAutoSectionsOrderKey
import com.sachit.music.constants.AndroidAutoYouTubePlaylistsKey
...
import com.sachit.music.ui.screens.settings.AndroidAutoSection
import com.sachit.music.ui.screens.settings.deserializeSections
import com.sachit.music.ui.screens.settings.serializeSections
                ...
                val children = when (parentId) {
                    ...
                    MusicService.YOUTUBE_PLAYLIST -> {
                        if (!context.dataStore.get(AndroidAutoYouTubePlaylistsKey, false)) {
                            ...
                            try {
                                val allSections = mutableListOf<com.sachit.innertube.pages.HomePage.Section>()
