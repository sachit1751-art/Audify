...
import com.sachit.music.betterlyrics.TTMLParser
import com.sachit.paxsenix.models.AppleMusicSearchResponse
import com.sachit.paxsenix.models.LyricsResponse

import com.sachit.paxsenix.models.SearchResult
        ...
        synchronized(this) {
            ...
            client = HttpClient(OkHttp) {
                ...
                defaultRequest {
                    ...
                    header("User-Agent", "Sachit Music/$appVersion")
                }
